...
namespace MrPlagueRacesVK.Common.Races.DeerPeople {
	public class DeerPeople : Race {
		public override string RaceSelectIcon => ($"MrPlagueRacesVK/Common/UI/RaceDisplay/DeerPeopleSelect");
		public override string RaceDisplayMaleIcon => ($"MrPlagueRacesVK/Common/UI/RaceDisplay/DeerPeopleDisplayMale");
		public override string RaceDisplayFemaleIcon => ($"MrPlagueRacesVK/Common/UI/RaceDisplay/DeerPeopleDisplayFemale");
		
		public override string RaceDisplayName => "Deer";
		public override string RaceLore1 => "Deers are very kind " +
											"\nand peaceful, they " +
											"\nonly fight when "+
											"\nabsolute necessary.";
		public override string RaceLore2 => "They live in the deepest forest " +
											"\ncomming out once a year to " +
											"\nprovide big festivals.";
		//public override string RaceEnvironmentIcon => ($"MrPlagueRaces/Common/UI/RaceDisplay/Environment/Environment_Hallow");
		
		public override string RaceHealthDisplayText => "[c/FF4F64:-25%]"; //Red
		public override string RaceManaRegenerationDisplayText => "[c/34EB93:+8]"; //Green
		public override string RaceDefenseDisplayText => "[c/FF4F64:-6]"; //Red
		public override string RaceMagicDamageDisplayText => "[c/34EB93:+15%]"; //Green
		public override string RaceSummonDamageDisplayText => "[c/34EB93:+10%]"; //Red
		public override string RaceMovementSpeedDisplayText => "[c/34EB93:+20%]"; //Green
		
		public override string RaceGoodBiomesDisplayText => "None";
		public override string RaceBadBiomesDisplayText => "None";
		
		public override string RaceAbilityName => "[c/34EB93:Celerity]";
		public override string RaceAbilityDescription1 => "Increases your [c/34EB93:Movement Speed] and [c/34EB93:Jump Speed] by [c/34EB93:20%] during 10 seconds";
		public override string RaceAbilityDescription2 => "This ability has a 30 seconds cooldown.";
		...
		public override void ProcessTriggers(Player player, Mod mod) {
			int vDebuff = ModContent.BuffType<RacialCooldown>();
			var modPlayer = player.GetModPlayer<MrPlagueRaces.MrPlagueRacesPlayer>();
			if (modPlayer.RaceStats) {
				if (MrPlagueRaces.MrPlagueRaces.RacialAbilityHotKey.Current && !player.dead && !player.HasBuff(vDebuff)) {
					player.AddBuff(vDebuff, 1800, true);
					player.AddBuff(ModContent.BuffType<Celerity>(), 600, true);
					Main.PlaySound(SoundID.Item4, player.position);
					for (int i = 0; i <= 30; i += 1) {
						Dust dust = Main.dust[Dust.NewDust(player.position, player.width, player.height, 156, 0f, 0f, 0, default, 2f)];
						dust.noGravity = true;
						dust.velocity *= 4;
					}
				}
		...
		public override void ModifyDrawInfo(Player player, Mod mod, ref PlayerDrawInfo drawInfo) {
			...
			if (modPlayer.resetDefaultColors) {
				...
				player.hairColor = new Color(255, 255, 255);
				player.skinColor = new Color(235, 221, 174);
				player.eyeColor = new Color(110, 110, 117);
			}
		}
		...
		public override void ModifyDrawLayers(Player player, List<PlayerLayer> layers) {
			...
			Main.playerTextures[0, 0] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Head");
			Main.playerTextures[0, 1] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Eyes_2");
			Main.playerTextures[0, 2] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Eyes");
			Main.playerTextures[0, 3] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Torso");
			...
			Main.playerTextures[0, 5] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Hands");
			...
			Main.playerTextures[0, 7] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Arm");
			...
			Main.playerTextures[0, 9] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Hand");
			Main.playerTextures[0, 10] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Legs");
			...
			Main.playerTextures[1, 0] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Head");
			Main.playerTextures[1, 1] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Eyes_2");
			Main.playerTextures[1, 2] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Eyes");
			Main.playerTextures[1, 3] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Torso");
			...
			Main.playerTextures[1, 5] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Hands");
			...
			Main.playerTextures[1, 7] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Arm");
			...
			Main.playerTextures[1, 9] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Hand");
			Main.playerTextures[1, 10] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Legs");
			...
			Main.playerTextures[2, 0] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Head");
			Main.playerTextures[2, 1] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Eyes_2");
			Main.playerTextures[2, 2] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Eyes");
			Main.playerTextures[2, 3] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Torso");
			...
			Main.playerTextures[2, 5] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Hands");
			...
			Main.playerTextures[2, 7] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Arm");
			...
			Main.playerTextures[2, 9] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Hand");
			Main.playerTextures[2, 10] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Legs");
			...
			Main.playerTextures[3, 0] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Head");
			Main.playerTextures[3, 1] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Eyes_2");
			Main.playerTextures[3, 2] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Eyes");
			Main.playerTextures[3, 3] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Torso");
			...
			Main.playerTextures[3, 5] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Hands");
			...
			Main.playerTextures[3, 7] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Arm");
			...
			Main.playerTextures[3, 9] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Hand");
			Main.playerTextures[3, 10] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Legs");
			...
			Main.playerTextures[8, 0] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Head");
			Main.playerTextures[8, 1] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Eyes_2");
			Main.playerTextures[8, 2] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Eyes");
			Main.playerTextures[8, 3] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Torso");
			...
			Main.playerTextures[8, 5] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Hands");
			...
			Main.playerTextures[8, 7] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Arm");
			...
			Main.playerTextures[8, 9] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Hand");
			Main.playerTextures[8, 10] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Legs");
			...
			Main.playerTextures[4, 0] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Head_Female");
			Main.playerTextures[4, 1] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Eyes_2_Female");
			Main.playerTextures[4, 2] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Eyes_Female");
			Main.playerTextures[4, 3] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Torso_Female");
			...
			Main.playerTextures[4, 5] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Hands_Female");
			...
			Main.playerTextures[4, 7] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Arm_Female");
			...
			Main.playerTextures[4, 9] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Hand_Female");
			Main.playerTextures[4, 10] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Legs_Female");
			...
			Main.playerTextures[5, 0] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Head_Female");
			Main.playerTextures[5, 1] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Eyes_2_Female");
			Main.playerTextures[5, 2] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Eyes_Female");
			Main.playerTextures[5, 3] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Torso_Female");
			...
			Main.playerTextures[5, 5] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Hands_Female");
			...
			Main.playerTextures[5, 7] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Arm_Female");
			...
			Main.playerTextures[5, 9] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Hand_Female");
			Main.playerTextures[5, 10] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Legs_Female");
			...
			Main.playerTextures[6, 0] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Head_Female");
			Main.playerTextures[6, 1] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Eyes_2_Female");
			Main.playerTextures[6, 2] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Eyes_Female");
			Main.playerTextures[6, 3] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Torso_Female");
			...
			Main.playerTextures[6, 5] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Hands_Female");
			...
			Main.playerTextures[6, 7] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Arm_Female");
			...
			Main.playerTextures[6, 9] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Hand_Female");
			Main.playerTextures[6, 10] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Legs_Female");
			...
			Main.playerTextures[7, 0] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Head_Female");
			Main.playerTextures[7, 1] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Eyes_2_Female");
			Main.playerTextures[7, 2] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Eyes_Female");
			Main.playerTextures[7, 3] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Torso_Female");
			...
			Main.playerTextures[7, 5] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Hands_Female");
			...
			Main.playerTextures[7, 7] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Arm_Female");
			...
			Main.playerTextures[7, 9] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Hand_Female");
			Main.playerTextures[7, 10] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Legs_Female");
			...
			Main.playerTextures[9, 0] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Head_Female");
			Main.playerTextures[9, 1] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Eyes_2_Female");
			Main.playerTextures[9, 2] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Eyes_Female");
			Main.playerTextures[9, 3] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Torso_Female");
			...
			Main.playerTextures[9, 5] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Hands_Female");
			...
			Main.playerTextures[9, 7] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Arm_Female");
			...
			Main.playerTextures[9, 9] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Hand_Female");
			Main.playerTextures[9, 10] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Legs_Female");
			...
			Main.playerHairTexture[0] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/Hair/DeerPeople_Hair_1");
			Main.playerHairTexture[1] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/Hair/DeerPeople_Hair_2");
			Main.playerHairTexture[2] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/Hair/DeerPeople_Hair_3");
			Main.playerHairTexture[3] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/Hair/DeerPeople_Hair_4");
			Main.playerHairTexture[4] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/Hair/DeerPeople_Hair_5");
			...
			Main.playerHairAltTexture[0] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/Hair/DeerPeople_Hair_1");
			Main.playerHairAltTexture[1] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/Hair/DeerPeople_Hair_2");
			Main.playerHairAltTexture[2] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/Hair/DeerPeople_Hair_3");
			Main.playerHairAltTexture[3] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/Hair/DeerPeople_Hair_4");
			Main.playerHairAltTexture[4] = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/Hair/DeerPeople_Hair_5");
			...
			Main.ghostTexture = ModContent.GetTexture("MrPlagueRacesVK/Content/RaceTextures/DeerPeople/DeerPeople_Ghost");
	}
}
/*
